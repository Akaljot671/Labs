...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser: User = User(userName: "Akaljot", email: "Akaljot6571@gmail.com", age: 21)
 ...
 */
let newUser = User(userName: "Akaljot", email: "Akaljot6571@gmail.com", age: 30)
